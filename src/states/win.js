class Win extends Phaser.State {
    ...
    create() {
        ...
        //add intro text
        this.menuText = this.add.text(this.game.world.centerX, this.game.world.centerY, 'U win!', {
    ...
    onInputDown() {
        ...
        //when the 'ready' tween is done, hide it and show 'go'. perform a shaking/rotating tween on 'go'. When 'go'
        // is done, start the game var go_tween_repeat_num = 3; //how many times these tweens should loop
